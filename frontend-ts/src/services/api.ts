...
export const deleteBill = (billId: number) => API.delete(`/bills/${billId}`);
export const fetchBillPreviewUrl = (billId: number) => API.get<{ signed_url: string }>(`/bill/${billId}/preview-url`);
